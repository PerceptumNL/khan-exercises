({
	"nl" : {
		...
		"hint22"	: '<strong><var>person(1)</var> heeft <var>plural(<var>SOLUTION</var>)</var> kopjes chocolade vlokken nodig om voldoende koekjes te maken voor de benefietverkoop.</strong>'
		}
})